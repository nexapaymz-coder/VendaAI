...
export default function VendaAI() {
  ...
  return (
    <main className="min-h-screen bg-[#050814] text-white p-5">
      <div className="mx-auto max-w-2xl">
        ...
        <section className="rounded-3xl border border-cyan-400/20 bg-white/5 p-5 backdrop-blur-xl">
          ...
          <textarea
            ...
            placeholder="Ex.: Crie um anúncio moderno mostrando esta manga, destaque o preço de 50 MT e incentive o cliente a comprar."
            rows={5}
